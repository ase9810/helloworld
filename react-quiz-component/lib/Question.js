...
function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderQuizResultQuestions", function () {
      ...
      return questions.map(function (question, index) {
        ...
        return _react.default.createElement("div", {
          ...
          dangerouslySetInnerHTML: "Q".concat(question.questionIndex, ": ")
          .concat( /*#__PURE__*/_react.default.createElement(_reactMathjax.default.Text, {
            text: _this.rawMarkup(question.question)
          }))
          ...
          }, question.questionType == 'text' && _react.default.createElement("span", null, 
          /*#__PURE__*/_react.default.createElement(_reactMathjax.default.Text, {
            text: answer
          })
          ), question.questionType == 'photo' && _react.default.createElement("img", {
            src: answer
          })));
  ...
  _createClass(Question, [{
    ...
    value: function render() {
      ...
      }, this.renderMessageforCorrectAnswer(question), this.renderExplanation(question, false))), _react.default.createElement("div", null, appLocale.question, " ", this.state.currentQuestionIndex + 1, ":"), _react.default.createElement("h3", 
      {
        dangerouslySetInnerHTML: /*#__PURE__*/_react.default.createElement(_reactMathjax.default.Text, {
          text: this.rawMarkup(question.question)
        })
      }
      ), question.answers.map(function (answer, index) {
